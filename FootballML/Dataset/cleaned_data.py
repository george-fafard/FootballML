...
def getTraining(previous_year,current_year,games,year):
...
#I think of it as an example, it just shows how to get training data from some data sets that are in a list 
"""
